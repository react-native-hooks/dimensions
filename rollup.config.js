...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-dimensions.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-dimensions',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-dimensions.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-dimensions.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-dimensions.esm.js',
    }),
  ],
};
